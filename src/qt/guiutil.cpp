...
{
    // Convert shadowX:// to shadowX:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("shadowX://"))
    {
        uri.replace(0, 12, "shadowX:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "ShadowX.lnk";
}
...
{
    return GetAutostartDir() / "shadowX.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "[Desktop Entry]\n" \
                   ...
                   << "MimeType=x-scheme-handler/shadowX;\n";
        optionFile.close();
    }
    return true;
}
