...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("ShadowX version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  shadowXd [options]                     " + "\n" +
                  "  shadowXd [options] <command> [params]  " + _("Send command to -server or shadowXd") + "\n" +
                  "  shadowXd [options] help                " + _("List commands") + "\n" +
                  "  shadowXd [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "shadowX:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect shadowXd signal handlers
    noui_connect();
